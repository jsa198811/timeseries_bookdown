...
```{r fig1, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig2, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig3, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig4, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig5, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig6, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}
...
```{r fig7, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center', message=FALSE, warning=FALSE}

diff_ts <- diff(c220.ts, lag = 12)

df <- data.frame(date = time(diff_ts), value = as.vector(diff_ts))
...
En este caso, se utilizó un rezago de 12 meses para tener el valor contra el cual hacer la diferencia. Hasta cierto punto, la gráfica pareciera apuntar a un ciclo que abarca varios años, lo cual podría dificultar la validación del análisis por la disponibilidad de los datos.
